mw.loader.load("https://mzh.moegirl.org.cn/index.php?title=User:BearBin/js/CtrlS.js&action=raw&ctype=text/javascript");
mw.loader.load("https://mzh.moegirl.org.cn/index.php?title=User:Nzh21/js/QuickDiff.js&action=raw&ctype=text/javascript");
mw.loader.load("https://mzh.moegirl.org.cn/index.php?title=User:BearBin/js/ListEnhancer.js&action=raw&ctype=text/javascript");
...
if (mw.config.get("wgCanonicalSpecialPageName") === "Movepage") {
  ...
  $("#wpReason").after($('<div id="move-reason" style="margin-top: .3em"></div>').append(reasons.map(function(reason) {
